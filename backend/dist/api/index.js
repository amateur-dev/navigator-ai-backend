globalThis.__RAINDROP_GIT_COMMIT_SHA = "950b960b16618ae6e151ae414be3908f81789e6e"; 
      ...
      data: {
        ...
        notifications: patientEmail || patientPhoneNumber ? {
          sms: patientPhoneNumber ? {
            ...
            length: 0
            // Would calculate in real implementation
          } : void 0,
          email: patientEmail ? {
            to: patientEmail,
...
app.post("/seed", async (c) => {
  try {
    ...
    const referralDates = [
      /* @__PURE__ */ new Date("2025-11-25T09:30:00Z"),
      // Monday
      /* @__PURE__ */ new Date("2025-11-25T14:15:00Z"),
      /* @__PURE__ */ new Date("2025-11-26T08:45:00Z"),
      // Tuesday
      /* @__PURE__ */ new Date("2025-11-26T16:20:00Z"),
      /* @__PURE__ */ new Date("2025-11-27T10:00:00Z"),
      // Wednesday
      /* @__PURE__ */ new Date("2025-11-27T13:30:00Z"),
      /* @__PURE__ */ new Date("2025-11-28T09:00:00Z"),
      // Thursday
      /* @__PURE__ */ new Date("2025-11-28T15:45:00Z"),
      /* @__PURE__ */ new Date("2025-11-29T11:20:00Z"),
      // Friday
      /* @__PURE__ */ new Date("2025-11-30T10:30:00Z"),
      // Saturday
      /* @__PURE__ */ new Date("2025-12-01T08:00:00Z"),
      // Sunday
      /* @__PURE__ */ new Date("2025-12-01T14:00:00Z"),
      /* @__PURE__ */ new Date("2025-12-02T09:15:00Z"),
      // Monday
      /* @__PURE__ */ new Date("2025-12-02T11:45:00Z"),
      /* @__PURE__ */ new Date("2025-12-02T15:30:00Z")
    ];
    for (let i = 0; i < demoReferrals.length; i++) {
      ...
      if (refId) {
        ...
        if (status === "Pending") {
          const eligibilityCheckTime = addHours(referralCreatedDate, Math.random() * 8 + 2);
          await logReferralEvent(
            db,
            refId,
        ...
        if (status === "Completed") {
          const appointmentCompletedTime = addDays(/* @__PURE__ */ new Date(), Math.random() * 6 - 3);
          await logReferralEvent(
            db,
            refId,
  ...
  try {
    ...
    if (rows.length > 0) {
      ...
      const getStepStatus = (stepIndex, currentStatus2) => {
        ...
        const completionLevel = statusMap[currentStatus2] || 0;
...
app.get("/referral/:id/logs", async (c) => {
  try {
    ...
    const numericId = referralIdParam.startsWith("ref-") ? referralIdParam.substring(4) : referralIdParam;
    const db = c.env.REFERRALS_DB;
...
app.get("/metrics", async (c) => {
  try {
    ...
    const successRate = overviewData.totalReferrals > 0 ? overviewData.totalCompleted / overviewData.totalReferrals * 100 : 0;
