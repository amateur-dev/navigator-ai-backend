...
export const ReferralSmsNotification = ({ to, message }: SmsNotificationProps) => {
  return (
    <div className="w-full flex flex-col border rounded-xl corner-smooth bg-background p-4 h-full">
      ...
      <p className="text-sm text-default bg-muted p-5 corner-smooth border border-border rounded-xl">
        {message}
      </p>
    </div>
  )
